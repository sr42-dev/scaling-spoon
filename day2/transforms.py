...
while True:
    ...
    #imgDilation = cv2.dilate(imgCanny, (10,10), iterations=1) # <Canny image variable>, <kernel (matrix)>, iterations = <thickness>
    ...
    #imgResult = mask  # adds two images and creates a new one where non black colours on the mask are given colour from the original
    #imgStacked = stackImages(0.5, ([img, imgResult])) # stacking images
    #cv2.imshow('Test window', img) # showing image
